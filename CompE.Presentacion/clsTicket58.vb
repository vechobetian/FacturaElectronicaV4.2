...
Public Class clsTicket58
    ...
    Private Sub FACTURA(ByVal sender As Object, ByVal e As PrintPageEventArgs)
        Dim fuenteGrande As Font = New Font("consolas", 13)
        ...
        For Each Item As ItemComprobante In Comprobante.Detalle
            ...
            Tab = StrDup(11 - Len(strCantPUnit), " ")
            ...
            If Item.ImporteDescuento > 0 Then
                ...
                If Left(Item.OtraDescripcion, 2) <> "OS" And Left(Item.OtraDescripcion, 2) <> "CS" Then
                    ...
                    strLinea2Item = strCantPUnit & Tab & StrDup(9 - Len(strIVA), " ") & strIVA & StrDup(12 - Len(strImpItem), " ") & strImpItem
        ...
        If Me.Comprobante.TipoComprobante.Letra = "A" Then
            strSubTotal = Format(Comprobante.ImpNeto + Comprobante.ImpEx, "Fixed")
            yPos += IncrementoYPreTexto
            ...
            strImpNeto = Format(Comprobante.ImpNeto, "Fixed")
            yPos += IncrementoYPreTexto
            e.Graphics.DrawString("Imp.Neto: " & StrDup(22 - Len(strImpNeto), " ") & strImpNeto, printFont, Brushes.Black, MargenIzquierdo, yPos)

            strIVA = Format(Comprobante.IVA, "Fixed")
            yPos += IncrementoYPreTexto
            e.Graphics.DrawString("I.V.A: " & StrDup(25 - Len(strIVA), " ") & strIVA, printFont, Brushes.Black, MargenIzquierdo, yPos)

            strTotal = Format(Comprobante.ImpBto, "Fixed")
            yPos += IncrementoYPreTexto
            e.Graphics.DrawString("TOTAL: " & StrDup(10 - Len(strTotal), " ") & strTotal, fuenteGrande, Brushes.Black, MargenIzquierdo, yPos)
